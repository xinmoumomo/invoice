...
use Xinmoumomo\Invoice\PackageInfo;
...
class InvoiceSDK
{
    ...
    public function create(array $arr)
    {
        ...
        $data['KPLX']       = $arr['KPLX'];
        $data['CZDM']       = $arr['CZDM'];
        $data['GHF_YHZH']   = $arr['GHF_YHZH'] ?? '';
        $data['GHF_DZ']     = $arr['GHF_DZ'] ?? '';
        $data['GHF_GDDH']   = $arr['GHF_GDDH'] ?? '';
        $data['YFP_DM']     = $arr['YFP_DM'] ?? '';
        $data['YFP_HM']     = $arr['YFP_HM'] ?? '';
